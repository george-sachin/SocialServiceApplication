...
public class PastActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String URL_TOP_250 =  AppConfig.URL+"getData1Past.php?uid=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2,
                ...
                String orgname=((TextView) view.findViewById(R.id.serial)).getText().toString();
                Intent i = new Intent(PastActivity.this, OrganisationInfo.class);
                        ...
                        if (response.length() > 0) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    String rank = movieObj.getString("orgname");
                                    String title = movieObj.getString("orgaccept");

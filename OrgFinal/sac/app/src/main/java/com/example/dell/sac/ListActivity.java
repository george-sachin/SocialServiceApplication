...
public class ListActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    int rank;
    private String URL_TOP_250 = "http://192.168.0.106/u206583551_swipe/";
        ...
        listView.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view, int arg2,
              ...
              // String album_id = ((TextView) view.findViewById(R.id.album_id)).getText().toString();
                String orgid = ((TextView) view.findViewById(R.id.serial)).getText().toString();
/*
                        ...
                        if (response.length() > 0) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                  ...
                                  /*  int*/ rank = movieObj.getInt("orgid");
                                    String title = movieObj.getString("orgname");
                                    String address = movieObj.getString("orgaddress");
                                    int phone = movieObj.getInt("orgphone");

                                    Movie m = new Movie(rank,title,address,phone);

...
/**
 * Created by vanessa on 01-07-2016.
 */
...
import com.example.vanessa.temp.helper.MoviePast;

import com.example.vanessa.temp.helper.SwipeListAdapterPast;
...
public class PastActivity extends ActionBarActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String URL_TOP_250 =  AppConfig.URL+"getOrgPast.php?orgid=";
                        ...
                        if (response.length() > 0) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    String rank = movieObj.getString("name");
                                    String title = movieObj.getString("info");
